		...
		let latencyElement = `<span class='kws_top_bar_section latencyElement' style='cursor:pointer;color:${latencyColor}'>⇅${latency}</span>`;
            ...
            fetchEligibleLocations() {
                ...
                setTimeout(() => {
                    ...
                    this.ball_locations_to_search = potentialLocationElements;
                    if (this.ball_locations_to_search.length > 0) {
