...
// Define helper functions first to make them available globally
...
// Create the DAILY_QUESTS object
var DAILY_QUESTS = {
    settings: {
        active: false,
        skipTypes: {
    ...
    initialize: function(locations) {
        ...
        if (locations && Array.isArray(locations)) {
            ...
            console.error("[DAILY QUESTS] Locations not provided or not an array!");
            this.locations = [];
        }
    ...
    setupEventHandlers: function() {
        ...
        $("body").on("click", ".dq_button.dq_toggle", () => {
            this.start(); // Use the alias function name
        });
        
        $("body").on("click", ".dq_button.dq_reset", () => {
            this.resetAllProgress(); // Use the alias function name
        });
    ...
    // Toggle active state - original function
    ...
    // Alias for toggleActive to match expected function name
    start: function() {
        this.toggleActive();
    },
    
    // Reset progress - original function
    ...
    // Alias for resetProgress to match expected function name
    ...
    moveToQuestGiver: function() {
        ...
        const location = this.locations[this.runtime.currentLocationIndex];
        setStatusMessage("Moving to quest giver in " + location.name);
